...
<nav class="dock" data-sveltekit-preload-data>
    <a href={resolve('/recording')} class:dock-active={isActive('/recording')}
       aria-current={isActive('/recording') ? 'page' : undefined}>
    ...
    <a href={resolve('/map')} class:dock-active={isActive('/map')}
